...
const PostCard = ({ post }) => {
    console.log(post)
    return (
        <div className='p-0 pb-12 m-8 bg-white rounded-lg shadow-lg lg:p-8'>
            ...
            <div className='text-center'>
                <Link href={`/post/${post.slug}`}>
                    <span className='inline-block px-8 py-3 text-lg font-medium text-white transition duration-500 transform bg-pink-600 rounded-full cursor-pointer hover:bg-pink-700 hover:-translate-y-1'>Continue Reading</span>
                </Link>
            </div>
        </div>
    )
